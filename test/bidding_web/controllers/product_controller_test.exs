defmodule BiddingWeb.ProductControllerTest do
  use BiddingWeb.ConnCase

  alias Bidding.Primary

  @create_attrs %{category: "some category", image: "some image", product_name: "some product_name", quantity: 42}
  ...
  def fixture(:product) do
    {:ok, product} = Primary.create_product(@create_attrs)
    product
  end
